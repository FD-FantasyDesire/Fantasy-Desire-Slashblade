 ...
 */
public class RenderOverCharge extends Render{
    ...
    public RenderOverCharge(RenderManager renderManager) {
        super(renderManager);
    }
    ...
    public void renderModel(Entity entity, double x, double y, double z, float yaw, float partialRenderTick) {
        ...
        if(entity instanceof EntityOverCharge) {
            color = ((EntityOverCharge) entity).getColor();
            lifetime = ((EntityOverCharge)entity).getLifeTime();
        }
        ...
        float scale = 0.01f * ((EntityOverCharge) entity).getScale();
