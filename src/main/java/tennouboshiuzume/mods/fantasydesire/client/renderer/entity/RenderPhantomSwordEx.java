...
public class RenderPhantomSwordEx extends Render<EntityPhantomSwordEx> {
    ...
    private void doDriveRender(EntityPhantomSwordEx entity, double dX, double dY, double dZ, float f, float f1)
    {
...
//                alpha);
        ...
        for(int idx = 0; idx < nVecPos.length; idx++)
        {
            ...
            wr.pos(dVec[nVecPos[idx][0]][0] * dScale, dVec[nVecPos[idx][0]][1] * dScale, dVec[nVecPos[idx][0]][2] * dScale).color(red, green, blue, 1.0f).endVertex();
            wr.pos(dVec[nVecPos[idx][1]][0] * dScale, dVec[nVecPos[idx][1]][1] * dScale, dVec[nVecPos[idx][1]][2] * dScale).color(red, green, blue, 1.0f).endVertex();
            wr.pos(dVec[nVecPos[idx][2]][0] * dScale, dVec[nVecPos[idx][2]][1] * dScale, dVec[nVecPos[idx][2]][2] * dScale).color(red, green, blue, 1.0f).endVertex();
        }
