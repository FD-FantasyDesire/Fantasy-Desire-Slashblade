...
public class EntityOverCharge extends EntityBase
{
    ...
    /** パラメータ：多段Hitの有無 */
    private static final DataParameter<Boolean> IS_MULTI_HIT = EntityDataManager.<Boolean>createKey(EntityOverCharge.class, DataSerializers.BOOLEAN);

    private static final DataParameter<Boolean> IS_OVER_WALL = EntityDataManager.<Boolean>createKey(EntityOverCharge.class, DataSerializers.BOOLEAN);

    private static final DataParameter<Integer> INTERVAL = EntityDataManager.<Integer>createKey(EntityOverCharge.class,DataSerializers.VARINT);

    private static final DataParameter<String> PARTICLE = EntityDataManager.<String>createKey(EntityOverCharge.class,DataSerializers.STRING);

    private static final DataParameter<Float> HIT_SCALE = EntityDataManager.<Float>createKey(EntityOverCharge.class,DataSerializers.FLOAT);
     ...
     * @param worldIn ワールド
     */
    public EntityOverCharge(World worldIn)
    {
        super(worldIn);
    }
    ...
    public final float getHitScale(){
        return getDataManager().get(HIT_SCALE);
    }
    public final void setHitScale(float hitscale){
        this.getDataManager().set(HIT_SCALE,hitscale);
    }
    /**
     * エンティティの更新処理.
     *
