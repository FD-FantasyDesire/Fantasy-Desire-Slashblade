...
//    String materialName = "flammpfeil.slashblade.named.muramasa";
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        loreList.appendTag(new NBTTagString((I18n.format("tennouboshiuzume.slashblade.OverCold.desc"))));
        loreList.appendTag(new NBTTagString((I18n.format("tennouboshiuzume.slashblade.OverCold.desc1"))));
        loreList.appendTag(new NBTTagString((I18n.format("tennouboshiuzume.slashblade.OverCold.desc2"))));
        loreList.appendTag(new NBTTagString((I18n.format("tennouboshiuzume.slashblade.OverCold.desc3"))));
